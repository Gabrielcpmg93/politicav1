...
const sponsorships: Sponsorship[] = [
    { 
        ...
        description: 'Um "incentivo" para apoiar políticas favoráveis aos negócios. A população pode não gostar.', 
        effects: { balance: 500, happiness: -5 } 
    },
    { 
        id: 'energyunlimited', 
        name: 'Doação da Energia Ilimitada', 
        description: 'Financiamento para "acelerar" projetos de energia. Vem com algumas ressalvas ambientais.', 
        effects: { balance: 500, happiness: -5 } 
    },
];
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-gray-700 text-white p-6 rounded-lg shadow-xl border-2 border-gray-600 w-full max-w-md mx-4">
                ...
                <p className="text-sm text-gray-300 mb-4">Corporações estão oferecendo apoio financeiro em troca de influência. Aceitar pode trazer benefícios imediatos, mas também consequências.</p>
                        ...
                        <div key={deal.id} className="bg-gray-800 p-4 rounded-md border border-gray-600">
                            ...
                            <div className="flex justify-between items-center mt-3">
                                <div className="text-sm font-mono">
                                    ...
                                    <span className="text-red-400 ml-4">Felicidade: {deal.effects.happiness}</span>
                                </div>
                                <button
